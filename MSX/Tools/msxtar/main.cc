...
#ifdef WIN32
void mkdir_ex(const char *name, int perm)
{
	_mkdir(name);
}
#else
...
#ifdef WIN32
	if (_strnicmp(imagesize.c_str(),"single",6) == 0){
#else
	if (strncasecmp(imagesize.c_str(),"single",6) == 0){
#endif
		nbSectors = 720;
#ifdef WIN32
	} else if (_strnicmp(imagesize.c_str(),"double",6) == 0){
#else
	} else if (strncasecmp(imagesize.c_str(),"double",6) == 0){
#endif
		nbSectors = 1440;
#ifdef WIN32
	} else if (_strnicmp(imagesize.c_str(),"ide",3) == 0){
#else
